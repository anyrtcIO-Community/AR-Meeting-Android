...
public class AR_AudioManager {
    ...
    /** Construction */
    public static AR_AudioManager create(Context context, Runnable deviceStateChangeListener) {
        return new AR_AudioManager(context, deviceStateChangeListener);
    }
    ...
    private AR_AudioManager(Context context,
        ...
        proximitySensor = ARProximitySensor.create(context, new Runnable() {
            // This method will be called each time a state change is detected.
            // Example: user holds his hand over the device (closer than ~5 cm),
            // or removes his hand from the device.
            public void run() {
                if (proximitySensorChange) {
