...
public class MediaCodecVideoDecoder {
  ...
  private static final String[] supportedVp8HwCodecPrefixes = {
      "OMX.qcom.", "OMX.Nvidia.", "OMX.Exynos.", "OMX.Intel.", "OMX.allwinner"};
  // List of supported HW VP9 decoders.
  private static final String[] supportedVp9HwCodecPrefixes = {"OMX.qcom.", "OMX.Exynos.", "OMX.allwinner"};
  // List of supported HW H.264 decoders.
  private static final String[] supportedH264HwCodecPrefixes = {
      "OMX.realtek", "OMX.qcom.", "OMX.MTK.", "OMX.Intel.", "OMX.Exynos.", "OMX.rk.", "OMX.hisi.", "OMX.k3.",
          "OMX.MS.", "OMX.allwinner", "OMX.Intel"}; //"OMX.k3."
