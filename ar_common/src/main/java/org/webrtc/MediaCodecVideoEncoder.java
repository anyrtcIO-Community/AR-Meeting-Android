...
public class MediaCodecVideoEncoder {
  ...
  //OMX.realtek.video.enc.avc
  private static final MediaCodecProperties realtekH264HwProperties = new MediaCodecProperties(
          "OMX.realtek.", Build.VERSION_CODES.KITKAT, BitrateAdjustmentType.FRAMERATE_ADJUSTMENT);
  ...
  private static final MediaCodecProperties rkH264HwProperties = new MediaCodecProperties(
          "OMX.rk.", Build.VERSION_CODES.KITKAT, BitrateAdjustmentType.FRAMERATE_ADJUSTMENT);
  private static final MediaCodecProperties k3H264HwProperties = new MediaCodecProperties(
          "OMX.k3.", Build.VERSION_CODES.KITKAT, BitrateAdjustmentType.FRAMERATE_ADJUSTMENT);
  private static final MediaCodecProperties hisiH264HwProperties = new MediaCodecProperties(
          "OMX.hisi.", Build.VERSION_CODES.KITKAT, BitrateAdjustmentType.FRAMERATE_ADJUSTMENT);
  private static final MediaCodecProperties msH264HwProperties = new MediaCodecProperties(
          "OMX.MS.", Build.VERSION_CODES.KITKAT, BitrateAdjustmentType.FRAMERATE_ADJUSTMENT);
  private static final MediaCodecProperties allwinnerH264HwProperties = new MediaCodecProperties(
          "OMX.allwinner.", Build.VERSION_CODES.KITKAT, BitrateAdjustmentType.FRAMERATE_ADJUSTMENT);
  private static final MediaCodecProperties intelH264HwProperties = new MediaCodecProperties(
          "OMX.Intel.", Build.VERSION_CODES.KITKAT, BitrateAdjustmentType.FRAMERATE_ADJUSTMENT);

  private static final MediaCodecProperties[] h264HwList = new MediaCodecProperties[] {
          realtekH264HwProperties, qcomH264HwProperties, mtkH264HwProperties, exynosH264HwProperties, rkH264HwProperties,
          hisiH264HwProperties, msH264HwProperties, allwinnerH264HwProperties, intelH264HwProperties
  };
